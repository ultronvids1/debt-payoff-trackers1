...
{q:"What matters more?",options:[
{text:"Quick wins",type:"snowball"},
{text:"Saving most interest",type:"avalanche"}]}
];
...
"You're better suited for the "+final.toUpperCase()+" method.";

document.getElementById("resultText").innerText=
"Enter your email to unlock your personalized payoff plan.";

document.getElementById("emailCapture").innerHTML=`
<input type="email" id="userEmail" placeholder="Enter your email">
<br><br>
<button class="btn primary" onclick="unlockTracker()">Unlock My Plan</button>
`;
}
